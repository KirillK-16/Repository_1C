...
Процедура УдалитьКаталогСФайлами(Путь) Экспорт
	...
	#Если Сервер Или ТолстыйКлиентОбычноеПриложение Или ВнешнееСоединение Тогда
		...
		КонецЕсли;
	#Иначе
		ОписаниеОповещения = Новый ОписаниеОповещения("УдалитьКаталогСФайламиКаталогСуществуетЗавершение", ЭтотОбъект, Путь);
...
Процедура УдалитьКаталогСФайламиКаталогСуществуетЗавершение(Существует, ДополнительныеПараметры) Экспорт
	
	Если Существует Тогда
		ОписаниеОповещения = Новый ОписаниеОповещения("УдалитьКаталогСФайламиУдалитьФайлыЗавершение", ЭтотОбъект);
		НачатьУдалениеФайлов(ОписаниеОповещения, ДополнительныеПараметры);
	КонецЕсли;
	
КонецПроцедуры

Процедура УдалитьКаталогСФайламиУдалитьФайлыЗавершение(ДополнительныеПараметры) Экспорт
	// Т.к. после удаления каталога нам ничего делать не надо,
