...
Процедура ПриЗаписиНаСервере(Отказ, ТекущийОбъект, ПараметрыЗаписи)
	...
	ЗаписиОЛожномСрабатывании = РегистрыСведений.ЛожныеТревогиКонтрольПодключений.СоздатьНаборЗаписей();
	ЗаписиОЛожномСрабатывании.Отбор.КонтрольнаяПроцедура.Установить(Объект.ИсточникЗадачи);
	ЗаписиОЛожномСрабатывании.Записать();
	...
	Если ИмяМакета <> Неопределено Тогда
		...
		Исключение
			...
			ЗаписьЖурналаРегистрации(
				...
				Метаданные.Задачи.ЗадачаОтветственному.Формы.ФормаЗадачиКонтрольПодключенийЛожнаяТревога,
				,
				Комментарий);
