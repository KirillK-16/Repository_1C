...
Процедура СформироватьПрограммно(Команда)
	...
	Если НЕ ПолучитьЗначениеПользовательскойНастройки("Автообновление", Отчет.КомпоновщикНастроек.Настройки, Отчет.КомпоновщикНастроек.ПользовательскиеНастройки) И АвтообновлениеВключено Тогда
		АвтообновлениеВключено = Ложь;
		Возврат;
	КонецЕсли;
	...
	Если ПолучитьЗначениеПользовательскойНастройки("Автообновление", Отчет.КомпоновщикНастроек.Настройки, Отчет.КомпоновщикНастроек.ПользовательскиеНастройки) Тогда
