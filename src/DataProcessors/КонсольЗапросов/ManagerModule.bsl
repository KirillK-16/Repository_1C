...
//
//Процедура ВыполнитьЗапрос(ПараметрыЗадания, Знач АдресХранилища) Экспорт 
Процедура ВыполнитьЗапрос(ТекстЗапроса, ПараметрыЗапроса, ТДРезультатаЗапроса, ПараметрыВыводаЗапроса, ОтчетПоВыполнениюЗапроса, МеткаЗапроса, Знач АдресХранилища ) Экспорт
	...
	СтрРезультат.Вставить("МассивЗапросов",МассивЗапросов);
	СтрРезультат.Вставить("ТДРезультатаЗапроса",ТДРезультатаЗапроса);
	СтрРезультат.Вставить("ОтчетПоВыполнениюЗапроса",ОтчетПоВыполнениюЗапроса);
	ПоместитьВоВременноеХранилище(СтрРезультат, АдресХранилища);
