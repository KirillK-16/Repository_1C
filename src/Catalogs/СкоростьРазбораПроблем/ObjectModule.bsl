...
Функция ПолучитьДанные(
	...
	|ГДЕ
	|	ОсновнаяТаблицаЗамеров.Решена = Истина И %УсловиеНаИнтервалДат
	|
	|";
		...
		Если ВычислитьАгрегатныеЗначения Тогда
			...
			Исключение
				...
				ЗаписьЖурналаРегистрации(
					...
					Метаданные.Справочники.СкоростьРазбораПроблем.МодульОбъекта,
					,
					Комментарий);
...
Функция ВсегоЗаПериод(Знач ДатаНачала, Знач ДатаОкончания) Экспорт
	...
	|	РегистрСведений.НовыеПроблемы КАК ОсновнаяТаблицаЗамеров
	|ГДЕ
	|	ОсновнаяТаблицаЗамеров.Решена = Истина
...
Функция РасчитатьПоказатель(МенеджерВременныхТаблиц, Детализация = Неопределено) Экспорт
	...
	|	РегистрСведений.НовыеПроблемы КАК ОсновнаяТаблицаЗамеров
	|	
	|	ВНУТРЕННЕЕ СОЕДИНЕНИЕ Справочник.СкоростьРазбораПроблем КАК СкоростьРазбораПроблем
	|	ПО СкоростьРазбораПроблем.Ссылка = &Показатель
	|
